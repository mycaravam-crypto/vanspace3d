...
// `price` is the empty box's list price in EUR, looked up at bauhaus.info
// (BAUHAUS Eurobox range) — omitted for non-Eurobox entries, where addBox()
// falls back to its own DEFAULT_PRICE (0). eb-l (60x40x42cm) has no exact
// match in Bauhaus's lineup; its price is the closest available size
// (60x40x40cm, 76l).
...
export const STANDARD_LIBRARY = [
    {
        id: 'eb-s', label: 'Eurobox S', w: 0.6, h: 0.17, d: 0.4, color: 0x0ea5e9, accent: 'sky', weight: 3, price: 10.15,
    },
    {
        id: 'eb-m', label: 'Eurobox M', w: 0.6, h: 0.32, d: 0.4, color: 0x2563eb, accent: 'blue', weight: 8, price: 13.70,
    },
    {
        id: 'eb-l', label: 'Eurobox L', w: 0.6, h: 0.42, d: 0.4, color: 0x6366f1, accent: 'indigo', weight: 12, price: 21.90,
    },
    {
        id: 'eb-m-half', label: 'Eurobox M (halb)', w: 0.4, h: 0.32, d: 0.3, color: 0x06b6d4, accent: 'cyan', weight: 5, price: 9.25,
    },
    {
